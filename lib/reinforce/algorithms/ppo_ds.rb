            ...
            # Loop over the episodes
              ...
              1.upto(num_episodes) do |episode_number|
                  ...
                  batch_size.times do |step|
                    ...
                    #warn "next_obs: #{next_obs}, reward: #{reward}, next_done: #{next_done}"
                  ...
                  Torch.no_grad do
                    ...
                    #warn "next_value: #{next_value} next_obs: #{next_obs}"
                  ...
                  #b_obs = obs.reshape(-1)#,@environment.state_size[0], @environment.state_size[1])# + @environment.state_size)
